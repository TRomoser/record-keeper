              ...
              <article className="max-w-sm mx-auto md:max-w-none grid md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 xl:gap-16 items-center">
                <a className="relative block group" href="#0">
                    ...
                    <figure className="relative h-0 pb-[56.25%] md:pb-[75%] lg:pb-[56.25%] overflow-hidden transform md:-translate-y-2 xl:-translate-y-4 group-hover:translate-x-0 group-hover:translate-y-0 transition duration-700 ease-out">
                        <img className="rounded-2xl border-dotted border-4 border-teal-600 bg-teal-400 p-8 inline-block absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-1000 ease-out" src="https://i.imgur.com/ivprwWb.png" width="540" height="303" alt="Blog post" />
                    </figure>
                </a>
                <div>
                    <header>
                    ...
                    <footer className="flex items-center mt-4">
                        ...
                        <div>
                            ...
                            <span className="text-gray-500">Dec 22, 2022</span>
                        </div>
                    </footer>
                  </div>
              </article>    
